...
public:
   ...
   */
  void update(const std::vector<std::tuple<int, double, double, double>>
...
private:
  ...
  std::map<int, std::pair<double, double>>
      landmarks_;          // Known landmark positions
   ...
   */
  Eigen::Vector2d measurementModel(const Eigen::VectorXd &state,
                                   int landmark_id);
